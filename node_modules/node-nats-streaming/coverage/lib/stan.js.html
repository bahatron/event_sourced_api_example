...
<html lang="en">
<head>
    <title>Code coverage report for lib/stan.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> stan.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">92.71% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>458/494</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<a name='L1118'></a><a href='#L1118'>1118</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if ('object' === typeof opts) {
...
function sanitizeUrl(host) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if ((/^.*:\/\/.*/).exec(host) === null) {
        // Does not have a scheme.
<span class="cstat-no" title="statement not covered" >        host = 'nats://' + host;</span>
    }
    const u = url.parse(host);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (u.port === null || u.port == '') {
<span class="cstat-no" title="statement not covered" >        host += ":" + DEFAULT_PORT;</span>
    }
    return host;
}
&nbsp;
...
&nbsp;
        ...
        this.nc.requestOne(discoverSubject, Buffer.from(req.serializeBinary()), 2 * 1000, (msg) =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (msg instanceof nats.NatsError) {
                let err = <span class="cstat-no" title="statement not covered" >msg;</span>
<span class="cstat-no" title="statement not covered" >                if (msg.code === nats.REQ_TIMEOUT) {</span>
<span class="cstat-no" title="statement not covered" >                    err = CONNECT_REQ_TIMEOUT;</span>
                }
<span class="cstat-no" title="statement not covered" >                this.closeWithError('error', err);</span>
...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (cr.getProtocol() &gt;= PROTOCOL_ONE) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (cr.getPingInterval() !== 0) {
                    unsubPingSub = false;
&nbsp;
...
&nbsp;
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (unsubPingSub) {
<span class="cstat-no" title="statement not covered" >                this.nc.unsubscribe(this.pingSubscription);</span>
<span class="cstat-no" title="statement not covered" >                this.pingSubscription = null;</span>
            }
&nbsp;
...
Stan.prototype.closeWithError = function(event, error) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.nc === undefined || this.clientID === undefined) {
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
...
&nbsp;
    ...
    if (!this.ncOwned &amp;&amp; this.nc) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.ackSubscription) {
            this.nc.unsubscribe(this.ackSubscription);
            this.ackSubscription = null;
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.pingSubscription) {
            this.nc.unsubscribe(this.pingSubscription);
            this.pingSubscription = null;
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.hbSubscription) {
            this.nc.unsubscribe(this.hbSubscription);
            this.hbSubscription = null;
        }
    }
    for (const guid in this.pubAckMap) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (this.pubAckMap.hasOwnProperty(guid)) {
            const a = this.removeAck(guid);
            <span class="missing-if-branch" title="else path not taken" >E</span>if (a &amp;&amp; a.ah &amp;&amp; typeof a.ah === 'function') {
                a.ah(err, guid);
            }
        }
    }
...
Stan.prototype.close = function() {
    ...
    //noinspection JSUnresolvedFunction
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.nc &amp;&amp; this.closeRequests) {
        ...
        this.nc.requestOne(this.closeRequests, Buffer.from(req.serializeBinary()), {}, this.options.connectTimeout, (msgOrError) =&gt; {
            ...
            if (msgOrError instanceof nats.NatsError) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (err &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >err.length &gt; 0)</span> {
                    // if the protocol returned an error there's nothing for us to handle, pass it as an arg to close notification.
<span class="cstat-no" title="statement not covered" >                    closeError = new Error(err);</span>
                }
            }
            // go closes always
            <span class="missing-if-branch" title="else path not taken" >E</span>if (nc &amp;&amp; this.ncOwned) {
                nc.close();
            }
            this.emit('close', closeError);
        });
    } else {
<span class="cstat-no" title="statement not covered" >        if (this.nc &amp;&amp; this.ncOwned) {</span>
<span class="cstat-no" title="statement not covered" >            this.nc.close();</span>
<span class="cstat-no" title="statement not covered" >            delete this.nc;</span>
        }
...
Stan.prototype.processAck = function() {
    return (msg) =&gt; {
        ...
        if (a &amp;&amp; a.ah) {
            ...
            a.ah(err === '' ? undefined : <span class="branch-1 cbranch-no" title="branch not covered" >err,</span> guid);
        }
    };
};
&nbsp;
...
Stan.prototype.removeAck = function(guid) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (a !== undefined) {
        delete this.pubAckMap[guid];
        this.pubAckOutstanding--;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (a.t !== undefined) {
            //noinspection JSUnresolvedFunction
...
&nbsp;
    ...
    if (typeof data === 'string') {
        ...
        buf = Buffer.from(data, 'utf8');
        data = new Uint8Array(buf);
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (Buffer.prototype.isPrototypeOf(Uint8Array)) {
...
&nbsp;
    ...
    //noinspection JSUnresolvedFunction
    ack.t = timers.setTimeout(<span class="fstat-no" title="function not covered" >()</span> =&gt; {
        const a = <span class="cstat-no" title="statement not covered" >this.removeAck(peGUID);</span>
<span class="cstat-no" title="statement not covered" >        if (a &amp;&amp; a.ah !== undefined) {</span>
<span class="cstat-no" title="statement not covered" >            a.ah(new Error(ACK_TIMEOUT), peGUID);</span>
        }
...
&nbsp;
    // fixme: hardcoded timeout
    this.nc.requestOne(this.subRequests, Buffer.from(sr.serializeBinary()), 2 * 1000, (msg) =&gt; {
        if (msg instanceof nats.NatsError) {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (msg.code === nats.REQ_TIMEOUT) {
                this.emit('timeout', SUB_REQ_TIMEOUT);
            } else {
<span class="cstat-no" title="statement not covered" >                this.emit('error', msg);</span>
            }
            return;
        }
        //noinspection JSUnresolvedVariable
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >err.length !== 0)</span> {
<span class="cstat-no" title="statement not covered" >            retVal.emit('error', new Error(err));</span>
<span class="cstat-no" title="statement not covered" >            this.nc.unsubscribe(retVal.inboxSub);</span>
<span class="cstat-no" title="statement not covered" >            retVal.emit('unsubscribed');</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
...
&nbsp;
    ...
    if (doClose) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!reqSubject) {
<span class="cstat-no" title="statement not covered" >            this.emit('error', new Error(NO_SERVER_SUPPORT));</span>
        }
    }
&nbsp;
...
&nbsp;
    // fixme: hardcoded timeout
    sc.nc.requestOne(reqSubject, Buffer.from(ur.serializeBinary()), 2 * 1000, (msg) =&gt; {
        let err;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (msg instanceof nats.NatsError) {
            const type = <span class="cstat-no" title="statement not covered" >doClose ? CLOSE_REQ_TIMEOUT : UNSUB_REQ_TIMEOUT;</span>
<span class="cstat-no" title="statement not covered" >            err = new nats.NatsError(type, type, msg);</span>
<span class="cstat-no" title="statement not covered" >            if (msg.code === nats.REQ_TIMEOUT) {</span>
<span class="cstat-no" title="statement not covered" >                this.emit('timeout', err);</span>
            } else {
...
<span class="cstat-no" title="statement not covered" >            return;</span>
        ...
        err = r.getError();
        <span class="missing-if-branch" title="if path not taken" >I</span>if (err &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >err.length &gt; 0)</span> {
<span class="cstat-no" title="statement not covered" >            this.emit('error', new Error(r.getError()));</span>
        } else {
...
Stan.prototype.processMsg = function() {
    ...
    return (rawMsg, reply, subject, sid) =&gt; {
        ...
        try {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (sub === undefined || !this.nc) {
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
...
<span class="cstat-no" title="statement not covered" >            sub.emit('error', error);</span>
        }
    };
};
&nbsp;
...
Message.prototype.getData = function() {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (encoding !== 'binary') {
        bytes = bytes.length &gt; 0 ? Buffer.from(bytes, encoding).toString() : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
    }
    return bytes;
};
&nbsp;
 ...
 * @returns {number}
 */
Message.prototype.getCrc32 = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    return this.msg.getCrc32();</span>
};
&nbsp;
/**
 ...
 */
Message.prototype.getClientID = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    return this.msg.getConnId();</span>
};
&nbsp;
Message.prototype.getConnectionID = <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    return this.msg.getClientId();</span>
};
&nbsp;
&nbsp;
/**
